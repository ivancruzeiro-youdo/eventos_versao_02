...
import { ChevronDown, ChevronRight, LayoutDashboard, Calendar, MapPin, Users, FileText, Settings, LogOut, ChefHat, Package, UtensilsCrossed, ShoppingCart, ClipboardList } from 'lucide-react';
        ...
        <header className="h-14 border-b bg-card flex items-center px-6 sticky top-0 z-10">
          <div className="flex items-center justify-between w-full max-w-7xl mx-auto">
            <h1 className="text-sm font-medium text-muted-foreground">
              {[...mainNavigation, ...kitchenNavigation, ...adminNavigation].find(n => pathname === n.href || pathname.startsWith(n.href + '/'))?.name || 'YOUDO Experience'}
            </h1>
          </div>
        </header>
